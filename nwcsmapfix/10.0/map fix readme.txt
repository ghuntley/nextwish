...
So you rushed out there to buy Counter-Strike retail only to find that half of the maps are missing and to play on public servers you need to either download Counter-Strike from Counter-Strike.net ( 80Mb ) or find someone with the downloadable version Counter-Strike installed and get them to send you over 25Mb of files. Never fear, this is what this modification is about - It installs all of the textures and maps that are missing from Counter-Strike Retail.
...
2) Load up Counter-Strike and connect to your favorite server!
