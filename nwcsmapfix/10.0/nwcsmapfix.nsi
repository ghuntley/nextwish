...
ComponentText "This will install NextWish's CStrike Map Fix v10.0 on your computer."
...
UninstallText "This will uninstall NextWish's CStrike Map Fix v10.0 from your computer. Hit Next to uninstall, or Cancel to cancel."
...
Delete "$INSTDIR\cstrike\Maps\as_highrise.*"
Delete "$INSTDIR\cstrike\Maps\as_tundra.*"
Delete "$INSTDIR\cstrike\Maps\cs_arabstreets.*"
Delete "$INSTDIR\cstrike\Maps\cs_estate.*"
Delete "$INSTDIR\cstrike\Maps\de_foption.*"
