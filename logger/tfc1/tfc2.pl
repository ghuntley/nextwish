#!/usr/bin/perl
################################################################################
## logger.pl written by [FK]Warmduscher (warmduscher@webax.de)                 #
##                                                                             #
## Description                                                                 #
...
## configuration                                                               #
################################################################################
my $log_port = 2710;             # Run the logger on this port. You have
...
sub getfreefilename()
{
   ...
   my @loglist;
   @loglist = `ls $filename\[0-9\]\[0-9\]\[0-9\].log 2> /dev/null| sort`;
